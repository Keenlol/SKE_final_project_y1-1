...
class Char:
    ...
    def pos(self, pos):
        ...
        self._grid_points = [[self._x-dx, self._y+dy], [self._x, self._y+dy], [self._x+dx, self._y+dy],
                            [self._x-dx, self._y], [self._x, self._y], [self._x+dx, self._y],
    ...
    def draw(self, char):
        ...
        if not sequence == []:
            turtle.goto(self._grid_points[sequence[0]][0], self._grid_points[sequence[0]][1])
            turtle.pendown()
            for i in range(1, len(sequence)):
                turtle.goto(self._grid_points[sequence[i]][0], self._grid_points[sequence[i]][1])
            turtle.penup()
